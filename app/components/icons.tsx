...
export function SunIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" {...props}>
      ...
      <path d="M12 2.5v2M12 19.5v2M4.1 4.1l1.4 1.4M18.5 18.5l1.4 1.4M2.5 12h2M19.5 12h2M4.1 19.9l1.4-1.4M18.5 5.5l1.4-1.4" />
    </svg>
  );
}
...
export function LinkedInIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M6.5 8.2H3.2V19h3.3V8.2ZM4.85 3A1.94 1.94 0 1 0 4.8 6.88 1.94 1.94 0 0 0 4.85 3ZM19 12.8c0-3.25-1.73-4.76-4.04-4.76a3.48 3.48 0 0 0-3.16 1.74V8.2H8.5V19h3.3v-5.35c0-1.41.27-2.78 2.02-2.78 1.73 0 1.75 1.62 1.75 2.87V19H19v-6.2Z" />
    </svg>
  );
}
